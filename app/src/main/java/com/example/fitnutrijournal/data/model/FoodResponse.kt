...
data class FoodItem(
    ...
    @SerializedName("DESC_KOR") val descKor: String?,
    ...
    @SerializedName("NUTR_CONT1") val nutrCont1: String?,
    @SerializedName("NUTR_CONT2") val nutrCont2: String?,
    @SerializedName("NUTR_CONT3") val nutrCont3: String?,
    @SerializedName("NUTR_CONT4") val nutrCont4: String?,
